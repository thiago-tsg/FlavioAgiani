...
import '../styles/Disponivel.scss';

const Disponivel = () => {
  return (
    <section className='disponivel-container'>
        ...
        <article className='grid3col'>
            <div className='card-disponel'>
                ...
                <p><span>Região:</span> Livre</p>
                <p><span>Modelo:</span> Minimalista</p>
                <p><span>Valor:</span> R$ 650,00</p>
